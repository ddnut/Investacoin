...
OutFile Investcoin-0.3.0-win32-setup.exe
...
Section -post SEC0001
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\CryptogenicBullion.lnk" $INSTDIR\Investcoin-qt.exe
    ...
    # CryptogenicBullion: URI handling disabled for 0.6.0
        ...
        WriteRegStr HKCR "CryptogenicBullion\DefaultIcon" "" $INSTDIR\Investcoin-qt.exe
        WriteRegStr HKCR "CryptogenicBullion\shell\open\command" "" '"$INSTDIR\Investcoin-qt.exe" "$$1"'
SectionEnd

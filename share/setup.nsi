...
!define MUI_FINISHPAGE_RUN $INSTDIR\Investacoin-qt.exe
...
OutFile Investacoin-0.3.0-win32-setup.exe
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    File ../release/Investacoin-qt.exe
    File /oname=license.txt ../COPYING
    File /oname=readme.txt ../doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File ../src/Investacoind.exe
...
Section -post SEC0001
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\CryptogenicBullion.lnk" $INSTDIR\Investacoin-qt.exe
    ...
    # CryptogenicBullion: URI handling disabled for 0.6.0
        ...
        WriteRegStr HKCR "CryptogenicBullion\DefaultIcon" "" $INSTDIR\Investacoin-qt.exe
        WriteRegStr HKCR "CryptogenicBullion\shell\open\command" "" '"$INSTDIR\Investacoin-qt.exe" "$$1"'
SectionEnd
...
Section /o -un.Main UNSEC0000
    Delete /REBOOTOK $INSTDIR\Investacoin-qt.exe

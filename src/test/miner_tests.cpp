...
BOOST_AUTO_INVT_SUITE(miner_tests)
...
BOOST_AUTO_INVT_CASE(CreateNewBlock_validity)
{
...
BOOST_AUTO_INVT_CASE(sha256transform_equality)
{
    ...
    BOOST_INVT_MESSAGE(hash.GetHex());

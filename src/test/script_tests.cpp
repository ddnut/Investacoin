...
read_json(const std::string& filename)
{
    ...
    {
        testFile = fs::path(BOOST_PP_STRINGIZE(INVT_DATA_DIR)) / filename;
    }
#endif
...
BOOST_AUTO_INVT_SUITE(script_tests)

BOOST_AUTO_INVT_CASE(script_valid)
{
...
BOOST_AUTO_INVT_CASE(script_invalid)
{
...
BOOST_AUTO_INVT_CASE(script_PushData)
{
...
BOOST_AUTO_INVT_CASE(script_CHECKMULTISIG12)
{
    CKey key1, key2, key3;
...
BOOST_AUTO_INVT_CASE(script_CHECKMULTISIG23)
{
...
BOOST_AUTO_INVT_CASE(script_combineSigs)
{

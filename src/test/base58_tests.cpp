...
BOOST_AUTO_INVT_SUITE(base58_tests)

// Goal: test low-level base58 encoding functionality
BOOST_AUTO_INVT_CASE(base58_EncodeBase58)
{
...
BOOST_AUTO_INVT_CASE(base58_DecodeBase58)
{
    Array tests = read_json("base58_encode_decode.json");
...
BOOST_AUTO_INVT_CASE(base58_keys_valid_parse)
{
...
BOOST_AUTO_INVT_CASE(base58_keys_valid_gen)
{
    Array tests = read_json("base58_keys_valid.json");
    std::vector<unsigned char> result;
    // Save global state
...
BOOST_AUTO_INVT_CASE(base58_keys_invalid)
{

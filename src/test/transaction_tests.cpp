...
BOOST_AUTO_INVT_SUITE(transaction_tests)

BOOST_AUTO_INVT_CASE(tx_valid)
{
...
BOOST_AUTO_INVT_CASE(tx_invalid)
{
...
BOOST_AUTO_INVT_CASE(basic_transaction_tests)
{
...
BOOST_AUTO_INVT_CASE(test_GetThrow)
{
    CBasicKeyStore keystore;
    MapPrevTx dummyInputs;
    std::vector<CTransaction> dummyTransactions = SetupDummyInputs(keystore, dummyInputs);

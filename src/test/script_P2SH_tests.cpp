...
BOOST_AUTO_INVT_SUITE(script_P2SH_tests)

BOOST_AUTO_INVT_CASE(sign)
{
...
BOOST_AUTO_INVT_CASE(norecurse)
{
...
BOOST_AUTO_INVT_CASE(switchover)
{
...
BOOST_AUTO_INVT_CASE(AreInputsStandard)
{

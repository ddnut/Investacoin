...
BOOST_AUTO_INVT_SUITE(DoS_tests)

BOOST_AUTO_INVT_CASE(DoS_banning)
{
    CNode::ClearBanned();
...
BOOST_AUTO_INVT_CASE(DoS_banscore)
{
    CNode::ClearBanned();
...
BOOST_AUTO_INVT_CASE(DoS_bantime)
{
    CNode::ClearBanned();
...
BOOST_AUTO_INVT_CASE(DoS_checknbits)
{
...
BOOST_AUTO_INVT_CASE(DoS_mapOrphans)
{
    CKey key;
    key.MakeNewKey(true);
...
BOOST_AUTO_INVT_CASE(DoS_checkSig)
{

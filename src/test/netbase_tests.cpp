...
BOOST_AUTO_INVT_SUITE(netbase_tests)

BOOST_AUTO_INVT_CASE(netbase_networks)
{
...
BOOST_AUTO_INVT_CASE(netbase_properties)
{
...
BOOST_AUTO_INVT_CASE(netbase_splithost)
{
...
BOOST_AUTO_INVT_CASE(netbase_lookupnumeric)
{
...
BOOST_AUTO_INVT_CASE(onioncat_test)
{

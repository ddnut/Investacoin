...
BOOST_AUTO_INVT_SUITE(util_tests)

BOOST_AUTO_INVT_CASE(util_criticalsection)
{
    CCriticalSection cs;
...
BOOST_AUTO_INVT_CASE(util_MedianFilter)
{    
...
BOOST_AUTO_INVT_CASE(util_ParseHex)
{
...
BOOST_AUTO_INVT_CASE(util_HexStr)
{
    BOOST_CHECK_EQUAL(
...
BOOST_AUTO_INVT_CASE(util_DateTimeStrFormat)
{
...
BOOST_AUTO_INVT_CASE(util_ParseParameters)
{
...
BOOST_AUTO_INVT_CASE(util_GetArg)
{
    mapArgs.clear();
...
BOOST_AUTO_INVT_CASE(util_WildcardMatch)
{
...
BOOST_AUTO_INVT_CASE(util_FormatMoney)
{
...
BOOST_AUTO_INVT_CASE(util_ParseMoney)
{
    int64 ret = 0;
...
BOOST_AUTO_INVT_CASE(util_IsHex)
{

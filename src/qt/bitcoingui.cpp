    ...
    optionsDialog(0)
{
    ...
    setWindowTitle(tr("Investacoin") + " " + tr("Wallet"));
...
//    tabGroup->addAction(statisticsAction);
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a investcoin address"));
...
//	connect(statisticsAction, SIGNAL(triggered()), this, SLOT(gotoStatisticsPage()));
    ...
    aboutCardAction = new QAction(tr("Investacoin Website"), this);
    aboutCardAction->setToolTip(tr("Go to Investacoin website"));
//	tutoStackAction = new QAction(tr("How to stake"), this);
//	tutoStackAction->setToolTip(tr("Learn how POS works"));
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About Investacoin"), this);
    aboutAction->setToolTip(tr("Show information about Investacoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for investcoin"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("investcoin client") + QString(" ") + tr("[testnet]"));
...
{
    QDesktopServices::openUrl(QUrl("http://investcoins.com/"));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid investcoin address or malformed URI parameters."));
    }
